    ...
    return (
        <>
            <div className="max-w-[35%] min-w-[315px] max-h-[85vh] bg-brand-gray rounded-xl my-3 border-2 border-gray-700 flex min-h-0 flex-col flex-1 self-stretch">
                ...
                <div className="mb-5 text-white text-xs ml-7">
                    {problem.difficulty === "Easy" && <span className="bg-green-500 px-2 py-1 rounded-full ">Easy</span>}
                    {problem.difficulty === "Medium" && <span className="bg-yellow-500 px-2 py-1 rounded-full ">Medium</span>}
                    {problem.difficulty === "Hard" && <span className="bg-red-500 px-2 py-1 rounded-full ">Hard</span>}
                </div>
